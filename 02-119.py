...
rmpath = "/Users/jackdunsford/Documents/dev/respmech/respmech.py"
...
settings = {
    "input": {
        "inputfolder": "/Users/jackdunsford/Library/CloudStorage/OneDrive-Personal/Thesis/02/02-119/ic",
        "files": "02-119_IC*.txt", #Filename or mask (e.g. "*.csv" for all CSV files in folder)
        "format": {
            #General settings
            "samplingfrequency": 1000, #No. of data recordings per second
            "decimalcharacter": ".", #Decimal character. Default is "."
        },
        "data": {
            "column_poes": 14,     #Column number containing oesophageal pressure
            "column_pgas": 15,    #Column number containing gastric pressure
            "column_pdi": 32,     #Column number containing transdiaphragmatic pressure
            "column_volume": 19, #Column number containing (inspired) volume, BTPS. Exclude this and specify "integratevolumefromflow: True" to instead obtain volume by integrating the flow signal.
            "column_flow": 18,   #Column number containing flow
            "columns_emg": [],   #The data columns containing EMG signals to calculate RMS from, e.g. [4,5,6,7,8]. Leave as [] to skip EMG calculation.
            "columns_entropy": [],   #The data columns to perform entropy calculation on, e.g. [4,5,6,7,8]. Leave as [] to skip entropy calculation.
        }
    },
    "processing": {
        "mechanics": {
            ...
            #Calculations:
            "separateby": "flow", #Which signal to use for detecting breathing cycles. Possible values: "flow" or "volume". Default: "flow". 
            ...
            "volumetrendpeakminprominence": 0.25,
    ...
    "output": {
        "outputfolder": "/Users/jackdunsford/Library/CloudStorage/OneDrive-Personal/Thesis/02/02-119/output/respmechoutput", #Note: Output folder must have two subfolders named "data" and "plots", respectively.
        "data": {
            #Data input/output
