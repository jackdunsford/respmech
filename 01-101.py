...
settings = {
    "input": {
        ...
        "files": "01-101_V3_ic_*.txt", #Filename or mask (e.g. "*.csv" for all CSV files in folder)
        "format": {
            #General settings
        ...
        "data": {
            "column_poes": 13,     #Column number containing oesophageal pressure
            "column_pgas": 14,    #Column number containing gastric pressure
            "column_pdi": 13,     #Column number containing transdiaphragmatic pressure
            ...
            "columns_emg": [3,4,5,6,7],   #The data columns containing EMG signals to calculate RMS from, e.g. [4,5,6,7,8]. Leave as [] to skip EMG calculation.
            "columns_entropy": [3,4,5,6,7],   #The data columns to perform entropy calculation on, e.g. [4,5,6,7,8]. Leave as [] to skip entropy calculation.
        }
    },
    "processing": {
        "mechanics": {
